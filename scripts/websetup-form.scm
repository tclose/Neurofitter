  ...
  `((Dimensions          2     (label "Number of model parameters to be fit: "))
    ...
    (FitterType  
     (Random Random
      ...
      (type button
	    (onclick 
	     "document.getElementById(\"NOMADParameters\").style.visibility=\"hidden\";"
	     "document.getElementById(\"SwarmParameters\").style.visibility=\"hidden\";"
	     "document.getElementById(\"RandomParameters\").style.visibility=\"visible\";")))
     (Swarm Swarm
      (label "Swarm Fitter")
      (type button
	    (onclick 
	     "document.getElementById(\"NOMADParameters\").style.visibility=\"hidden\";"
	     "document.getElementById(\"SwarmParameters\").style.visibility=\"visible\";"
	     "document.getElementById(\"RandomParameters\").style.visibility=\"hidden\";")))

     (NOMAD NOMAD
      (label "NOMAD Fitter")
      (type button
	    (onclick 
	     "document.getElementById(\"NOMADParameters\").style.visibility=\"visible\";"
	     "document.getElementById(\"SwarmParameters\").style.visibility=\"hidden\";"
	     "document.getElementById(\"RandomParameters\").style.visibility=\"hidden\";"))))

    (RandomParameters (optional)
		      (NumberOfPoints 2 (label "Number of points: ")))

    (SwarmParameters (optional)
		     (NumberOfPoints 2 (label "Number of points: ")))

    (NOMADParameters (optional)
